...
class SignUp(Resource):
    def post(self):
        ...
        if UserModel.find_by_username(data['username']):
            return {'msg': 'User {} already exists'.format(data['username'])}, 401
        ...
        try:
            ...
            new_user.save_to_db()
            return {'msg': 'User {} was created'.format(data['username'])}, 201
        except:
...
class Login(Resource):
    def post(self):
        ...
        try:
            ...
            if not current_user:
                return {'msg': 'User {} doesnt exist'.format(data['username'])}, 401
...
class LogoutAccess(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            revoked_token.add()
            return {'msg': 'Access token has been revoked'}, 201
        except:
            return {'msg': 'Something went wrong'}, 500
...
class UserLocation(Resource):
    ...
    def post(self):
        ...
        data = parser.parse_args()
        new_location = LocationModel(user_id=self.current_user_id(),
                                     lon=data['lon'],
                                     lat=data['lat'],
                                     name=data['name'],
    ...
    def put(self):
        ...
        update_location.name = data['name']
...
class SecretResource(Resource):
    resource_fields = {'user_id': fields.Integer, 'username': fields.String}
